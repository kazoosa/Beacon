      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-fg-muted mt-0.5">
            For brokers auto-sync doesn't support — download your positions as CSV and upload here.
          </p>
        </div>
      </div>
        ...
        <>
          ...
          <div>
            ...
            >
              ...
              <div className="text-[10px] text-fg-muted mt-1">
                Standard {brokers.data?.brokers.find((b) => b.key === broker)?.label ?? ""} positions export
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              onClick={() => previewMut.mutate({ broker, csv })}
            >
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-2 pt-2">
            <button
              ...
              onClick={() => importMut.mutate({ broker, csv })}
            >
